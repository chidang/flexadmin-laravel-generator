...
return [
  ...
  'path' => [
    ...
    'routes'            => base_path('routes/admin_generator.php'),
    ...
    'menu_file'         => resource_path('views/layouts/admin/partials/left-sidebar/generator.blade.php'),
  ],
