...
class {{ $config->modelNames->name }}Controller extends AppBaseController
{
    ...
    {
        return view('{{ $config->prefixes->getViewPrefixForInclude() }}{{ $config->modelNames->snakePlural }}.create_modal');
    }

    public function chiDang()
    {
         return view('{{ $config->prefixes->getViewPrefixForInclude() }}{{ $config->modelNames->snakePlural }}.create');
    }
    ...
    public function store(Create{{ $config->modelNames->name }}Request $request)
    {
        ...
        @include('flex-laravel-generator::scaffold.controller.messages.save_success')
    ...
    public function show($id)
    {
        ...
        @include('flex-laravel-generator::scaffold.controller.messages.not_found')
    ...
    public function update($id, Update{{ $config->modelNames->name }}Request $request)
    {
        ...
        @include('flex-laravel-generator::scaffold.controller.messages.update_success')
    ...
    public function destroy($id)
    {
        ...
        @include('flex-laravel-generator::scaffold.controller.messages.delete_success')
