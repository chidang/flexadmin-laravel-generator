...
class APIControllerGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        ...
        $templateData = view('flex-laravel-generator::api.controller.'.$viewName, $this->variables())->render();

        g_filesystem()->createFile($this->path.$this->fileName, $templateData);

        $this->config->commandComment(techamz_nl().'API Controller created: ');
    ...
    protected function docsVariables(): array
    {
        ...
        if ($this->config->options->swagger) {
            ...
            $templateType = 'flex-laravel-generator';
        }
