...
class FactoryGenerator extends BaseGenerator
{
    ...
    {
        $templateData = view('flex-laravel-generator::model.factory', $this->variables())->render();

        g_filesystem()->createFile($this->path.$this->fileName, $templateData);

        $this->config->commandComment(techamz_nl().'Factory created: ');
    ...
    protected function generateFields(): string
    {
        ...
        return implode(','.techamz_nl_tab(1, 3), $fields);
    }
    ...
    public function getRelationsBootstrap(): array
    {
        ...
        foreach ($this->relations as $field => $data) {
            ...
            techamz_nl_tab(1, 2).'}'.techamz_nl();
            $uses .= techamz_nl()."use $qualifier;";
        }
