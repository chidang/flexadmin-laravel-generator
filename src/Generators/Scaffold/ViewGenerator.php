...
use Techamz\Generator\Generators\ViewServiceProviderGenerator;
use Techamz\Generator\Utils\HTMLFieldGenerator;
...
//        }
        ...
        $this->config->commandComment(techamz_nl().'Generating Views...');
    ...
    protected function generateBladeTableBody(): string
    {
        ...
        $tableBodyFields = implode(techamz_nl_tab(1, 5), $tableBodyFields);
    ...
    protected function generateTableHeaderFields(): string
    {
        ...
        return implode(techamz_nl_tab(1, 4), $headerFields);
    }
...
//            }
        ...
        g_filesystem()->createFile($this->path.'fields.blade.php', implode(techamz_nls(2), $htmlFields));
