...
namespace Techamz\Generator\Utils;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName, $ignoredFields, $connection = '')
    {
        ...
        $mappings = config('flex_laravel_generator.from_table.doctrine_mappings', []);
        ...
        $this->defaultSearchable = config('flex_laravel_generator.options.tables_searchable_default', false);
    }
    ...
    public static function getTimestampFieldNames()
    {
        ...
        $createdAtName = config('flex_laravel_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('flex_laravel_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('flex_laravel_generator.timestamps.deleted_at', 'deleted_at');
